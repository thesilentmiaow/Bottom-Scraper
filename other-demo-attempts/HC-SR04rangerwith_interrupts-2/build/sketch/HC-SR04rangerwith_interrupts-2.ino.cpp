#include <Arduino.h>
#line 1 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino"
#line 1 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino"
/*
...
#define buzzerPin 10                                 // Pin 10 buzzer PIN
...
// ----------------------------------
#line 43 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino"
void setup();
#line 61 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino"
void loop();
#line 72 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino"
void timerIsr();
#line 84 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino"
void trigger_pulse();
#line 119 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino"
void echo_interrupt();
#line 140 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino"
...
void setup() 
{
  ...
  pinMode(buzzerPin, OUTPUT);                        // Onboard LED pin set to output
  digitalWrite( onBoardLED, LOW);  //Make sure LED is off and buzzer is quiet  
...
void distance_flasher()
{
     // Serial.println(range_flasher_counter); 
      ...
      {                                                // Flash timer time out
         ...
         digitalWrite( onBoardLED, digitalRead( onBoardLED ) ^ 1 );   // Toggle the led
         
         if (distance < 25) {  // Only beep if less than 25cm
          digitalWrite( buzzerPin, digitalRead( buzzerPin ) ^ 1 );   // Toggle the buzzer
         } else {
          digitalWrite( buzzerPin, LOW );   // Switch the buzzer off
         }
      }
}
