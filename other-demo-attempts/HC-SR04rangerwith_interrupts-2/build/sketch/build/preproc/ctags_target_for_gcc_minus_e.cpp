# 1 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino"
# 1 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino"
/*
...
# 21 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino" 2
# 30 "/Users/timhodges/Google Drive/ArduinoProjectCode/HC-SR04rangerwith_interrupts-2/HC-SR04rangerwith_interrupts-2.ino"
...
void setup()
{
  pinMode(12 /* Pin 12 trigger output*/, 0x1); // Trigger pin set to output
  pinMode(2 /* Pin 2 Echo input*/, 0x0); // Echo pin set to input
  pinMode(13 /* Pin 13 onboard LED*/, 0x1); // Onboard LED pin set to output
  pinMode(10 /* Pin 10 buzzer PIN*/, 0x1); // Onboard LED pin set to output
  digitalWrite( 13 /* Pin 13 onboard LED*/, 0x0); //Make sure LED is off and buzzer is quiet  
  Timer1.initialize(50 /* 50 uS timer duration */); // Initialise timer 1
  Timer1.attachInterrupt( timerIsr ); // Attach interrupt to the timer service routine 
  attachInterrupt(((2 /* Pin 2 Echo input*/) == 2 ? 0 : ((2 /* Pin 2 Echo input*/) == 3 ? 1 : -1)), echo_interrupt, 1); // Attach interrupt to the sensor echo input
...
void loop()
{
    distance = echo_duration / 58; //calculate range in cm
...
void trigger_pulse()
{
      ...
      { // Time out - Initiate trigger pulse
         trigger_time_count = 4000 /* 200 mS worth of timer ticks*/; // Reload
      ...
      switch(state) // State machine handles delivery of trigger pulse
      {
        ...
        case 1: // Initiate pulse
           digitalWrite(12 /* Pin 12 trigger output*/, 0x1); // Set the trigger output high
           state = 2; // and set state to 2
           break;

        case 2: // Complete the pulse
        default:
           digitalWrite(12 /* Pin 12 trigger output*/, 0x0); // Set the trigger output low
...
void echo_interrupt()
{
  switch (digitalRead(2 /* Pin 2 Echo input*/)) // Test to see if the signal is high or low
  {
    case 0x1: // High so must be the start of the echo pulse
      echo_end = 0; // Clear the end time
      echo_start = micros(); // Save the start time
      break;

    case 0x0: // Low so must be the end of hte echo pulse
...
{
     // Serial.println(range_flasher_counter); 
      ...
      { // Flash timer time out
         ...
         digitalWrite( 13 /* Pin 13 onboard LED*/, digitalRead( 13 /* Pin 13 onboard LED*/ ) ^ 1 ); // Toggle the led

         if (distance < 25) { // Only beep if less than 25cm
          digitalWrite( 10 /* Pin 10 buzzer PIN*/, digitalRead( 10 /* Pin 10 buzzer PIN*/ ) ^ 1 ); // Toggle the buzzer
         } else {
          digitalWrite( 10 /* Pin 10 buzzer PIN*/, 0x0 ); // Switch the buzzer off
         }
      }
}
